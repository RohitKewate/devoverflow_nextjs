...
const NavContent = () => {
    ...
    return (
        <section className='flex h-full flex-col gap-3 pt-11'>
        ...
        <Sheet>
            ...
            <SheetContent side='left' className='background-light900_dark200 '>
                <Link href="/" className='flex items-center gap-1'>
                    <Image src="/assets/images/site-logo.svg" alt='DevOverflow Logo' width={30} height={30} />
                    <p className='h2-bold text-dark100_light900 font-spaceGrotesk'>Dev<span className='text-primary-500'>Overflow</span></p>
                </Link>
                <div className='mb-10 h-full overflow-auto pb-10'>
                    <SheetClose className='mt-0 w-full border-none '>
                        <NavContent />
